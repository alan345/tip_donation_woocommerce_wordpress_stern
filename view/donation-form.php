<div class="rp-donation-block checkout_donation" >
    ...
    <div>
      <input type="button" value="$5" class="button donate-btn-5" name="donate-btn-20">
      <input type="button" value="$10" class="button donate-btn-10" name="donate-btn-20">
      <input type="button" value="$20" class="button donate-btn-20" name="donate-btn-20">
      <input type="button" value="$30" class="button donate-btn-20" name="donate-btn-20">
    </div>
    <div class="input text">
        <input type="text" value="<?php echo $amount; ?>" class="input-text text-donation donation-amount" name="donation-amount">
        <input type="button" value="Custom" class="button donate-btn" name="donate-btn">
